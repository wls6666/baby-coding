...
export class BabyCodingPanel implements vscode.WebviewViewProvider {
  ...
  private _getHtmlForWebview(_webview: vscode.Webview) {
    ...
    <head>
        <meta charset="UTF-8">
        <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${_webview.cspSource} 'unsafe-inline'; script-src 'nonce-${nonce}'; font-src ${_webview.cspSource} 'self' data: https:; img-src ${_webview.cspSource} 'self' data: https:;">
